<?php
/*
 * Template part for content on page
 */
...
<div class="<?php echo esc_attr($panel_class); ?>" <?php if(get_the_title(get_the_ID())==='Home'){echo 'style=" '.esc_attr('padding-top:0;').'"';}?> >
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="entry-content post-content">
				<?php
					...
					if(get_post_type() == 'post' && !empty($post_data['show_featured_image']) && has_post_thumbnail()) {
						echo '<div class="blog-post-image centered">';
						ppn_post_thumbnail('ppn-post-thumb',false, 'img-responsive');
						echo '</div>';
					}
					the_content();
				?>
